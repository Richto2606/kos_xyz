...
Route::get('/booking/status', [BookingController::class, 'statusForm'])->name('booking.status.form');
Route::post('/booking/status', [BookingController::class, 'status'])->name('booking.status');
