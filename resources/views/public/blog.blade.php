    ...
    <div class="blog-grid">
        ...
        <a href="{{ route('public.artikel.detail', $artikel->slug) }}" class="blog-card">
            ...
            <div class="content">
                ...
                <div class="deskripsi">{{ $artikel->deskripsi_singkat ?? strip_tags(substr($artikel->isi, 0, 150)) . '...' }}</div>
                <div class="meta">
                    <span class="penulis"><i class="fas fa-user"></i> {{ $artikel->penulis }}</span>
