...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('admin.kamar.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group-modern">
            ...
            <input type="text" id="nama" name="nama" required value="{{ old('nama') }}" placeholder="Contoh: Kamar F" />
        </div>
        ...
        <div class="form-group-modern">
            ...
            <input type="text" id="fasilitas" name="fasilitas" value="{{ old('fasilitas', 'AC, KM Dalam, Meja, Kursi, Lemari, Tempat Tidur') }}" placeholder="Pisahkan dengan koma" />
