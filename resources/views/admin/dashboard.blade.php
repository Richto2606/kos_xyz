...
<div style="padding: 0 0 10px 0;">
    ...
    <div class="target-card">
        ...
        <div style="display:flex; justify-content:space-between; font-size:0.75rem; color:#94a3b8; margin-top:4px;">
            <span>0%</span>
            <span>{{ $persentase >= 80 ? '✅ Target hampir tercapai!' : ($persentase >= 50 ? '🚀 Semangat!' : '💪 Ayo tingkatkan!') }}</span>
            <span>100%</span>
        </div>
    </div>
            ...
            <div class="notif-list">
                ...
                <div class="notif-item">
                    ...
                    <div class="notif-content">
                        ...
                        <div class="time">{{ $notif['time'] ?? 'Baru saja' }}</div>
                    </div>
                </div>
                @empty
            ...
            <div class="notif-list">
                ...
                <div class="notif-item">
                    ...
                    <div class="notif-content">
                        ...
                        <div class="time">{{ $aktivitasItem['time'] ?? 'Baru saja' }}</div>
                    </div>
                </div>
                @empty
