...
<div class="tagihan-stats">
    ...
    <div class="tagihan-stat-card">
        <div class="number orange">Rp <?php echo e(number_format($totalNominal, 0, ',', '.')); ?></div>
    ...
    <div style="overflow-x:auto;">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><strong><?php echo e($tagihan->penyewa->nama_lengkap ?? '-'); ?></strong></td>
                    <td><?php echo e($tagihan->bulan); ?> <?php echo e($tagihan->tahun); ?></td>
...
<div class="calendar-container" id="calendarContainer">
    <div class="calendar-header">
        ...
        <div class="calendar-nav">
            ...
            <span class="month-label" id="monthLabel"><?php echo e(\Carbon\Carbon::now()->translatedFormat('F Y')); ?></span>
...
<script>
    ...
    let currentMonth = <?php echo e(\Carbon\Carbon::now()->month); ?>;
    let currentYear = <?php echo e(\Carbon\Carbon::now()->year); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kerjaan\kos_xyz-main\kos_xyz-main\resources\views/admin/tagihan/index.blade.php ENDPATH**/ ?>