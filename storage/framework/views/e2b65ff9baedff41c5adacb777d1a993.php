...
<head>
    ...
    <meta name="description" content="Detail kamar <?php echo e($kamar->nama); ?> di Kos XYZ Yogyakarta. Harga Rp <?php echo e(number_format($kamar->harga, 0, ',', '.')); ?>/bulan. Fasilitas: <?php echo e($kamar->fasilitas); ?>." />
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(route('home')); ?>#sejarah">Sejarah</a>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <a href="<?php echo e(route('home')); ?>#kamar">Kamar</a>
            <span>/</span>
            <span><?php echo e($kamar->nama); ?></span>
        </div>
        ...
        <div class="detail-grid">
            ...
            <div class="detail-image">
                ...
                <?php else: ?>
                    <img src="<?php echo e(asset('images/kamar-default.jpg')); ?>" alt="<?php echo e($kamar->nama); ?>">
                <?php endif; ?>
                <span class="status-badge <?php echo e(strtolower($kamar->status)); ?>">
                    <i class="fas fa-<?php echo e($kamar->status == 'Tersedia' ? 'check-circle' : ($kamar->status == 'Penuh' ? 'times-circle' : 'hammer')); ?>"></i>
            ...
            <div class="detail-info">
                <h1 class="nama-kamar"><?php echo e($kamar->nama); ?></h1>
                <div class="alamat">
                ...
                <p class="deskripsi"><?php echo e($kamar->deskripsi ?? 'Kamar nyaman dengan fasilitas lengkap untuk mendukung aktivitas sehari-hari.'); ?></p>
                ...
                <div class="fasilitas-detail">
                    <?php $__currentLoopData = explode(',', $kamar->fasilitas ?? ''); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(trim($fas)): ?>
                        <span class="tag"><i class="fas fa-check-circle"></i> <?php echo e(trim($fas)); ?></span>
                        <?php endif; ?>
                ...
                <div class="info-grid">
                    <div class="item">
                        ...
                        <div class="value"><?php echo e($kamar->status); ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Harga</div>
                        <div class="value">Rp <?php echo e(number_format($kamar->harga, 0, ',', '.')); ?></div>
                    </div>
                    <div class="item">
                        <div class="label">Fasilitas</div>
                        <div class="value"><?php echo e(count(explode(',', $kamar->fasilitas ?? ''))); ?> fasilitas</div>
                    </div>
                    <div class="item">
                ...
                <div class="action-buttons">
                    <?php if($kamar->status == 'Tersedia'): ?>
                        <a href="https://wa.me/628123456789?text=Halo%20Kos%20XYZ%2C%20saya%20tertarik%20dengan%20<?php echo e(urlencode($kamar->nama)); ?>%20dan%20ingin%20booking%20sekarang." 
                           class="btn-booking" target="_blank">
                            <i class="fab fa-whatsapp"></i> Booking Sekarang
                        </a>
                    <?php else: ?>
                        <a href="https://wa.me/628123456789?text=Halo%20Kos%20XYZ%2C%20saya%20tertarik%20dengan%20<?php echo e(urlencode($kamar->nama)); ?>.%20Apakah%20ada%20kamar%20lain%20yang%20tersedia%3F" 
                           class="btn-booking" target="_blank" style="background:#f59e0b; box-shadow:0 4px 16px rgba(245,158,11,0.3);">
                            <i class="fab fa-whatsapp"></i> Tanya Ketersediaan
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('home')); ?>#kamar" class="btn-back">
        ...
        <!-- ===== KAMAR LAINNYA ===== -->
        <?php if(isset($kamars) && $kamars->count() > 1): ?>
        <div class="rekomendasi-section">
            <h2><i class="fas fa-thumbs-up"></i> Kamar Lainnya</h2>
            <div class="kamar-grid">
                <?php $__currentLoopData = $kamars->where('id', '!=', $kamar->id)->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('public.kamar.detail', $k->id)); ?>" class="kamar-card-mini">
                    <div class="img">
                        <?php if($k->gambar && file_exists(storage_path('app/public/kamar/' . $k->gambar))): ?>
                            <img src="<?php echo e(asset('storage/kamar/' . $k->gambar)); ?>" alt="<?php echo e($k->nama); ?>">
                        <?php else: ?>
                            <img src="<?php echo e(asset('images/kamar-default.jpg')); ?>" alt="<?php echo e($k->nama); ?>">
                        <?php endif; ?>
                    </div>
                    <div class="body">
                        <div style="display:flex; justify-content:space-between; align-items:center;">
                            <span class="nama"><?php echo e($k->nama); ?></span>
                            <span class="badge-mini <?php echo e($k->status == 'Tersedia' ? 'success' : ($k->status == 'Penuh' ? 'danger' : 'warning')); ?>">
                                <?php echo e($k->status); ?>

                            </span>
                        </div>
                        <div class="harga">Rp <?php echo e(number_format($k->harga, 0, ',', '.')); ?></div>
                        <div style="font-size:0.8rem; color:#94a3b8; margin-top:4px;">
                            <i class="fas fa-tag"></i> <?php echo e(count(explode(',', $k->fasilitas ?? ''))); ?> fasilitas
                        </div>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
