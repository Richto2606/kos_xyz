...
<head>
    ...
    <title><?php echo e($artikel->judul); ?> · Kos XYZ</title>
    <meta name="description" content="<?php echo e($artikel->deskripsi_singkat ?? strip_tags(substr($artikel->isi, 0, 160))); ?>" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <a href="<?php echo e(route('public.blog')); ?>">Blog</a>
            <span>/</span>
            <span><?php echo e($artikel->judul); ?></span>
        </div>
        ...
        <div class="artikel-detail">
            ...
            <div class="meta">
                ...
                <span><i class="far fa-clock"></i> <?php echo e($artikel->created_at->diffForHumans()); ?></span>
            </div>
            ...
            <a href="<?php echo e(route('public.blog')); ?>" style="display:inline-block; margin-top:20px; color:#b45309; text-decoration:none; font-weight:600;">
        ...
        <div class="terkait-section">
            ...
            <div class="terkait-grid">
                <?php $__currentLoopData = $artikelTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artikelTerkait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('public.artikel.detail', $artikelTerkait->slug)); ?>" class="terkait-card">
                    <div class="image">
                        <img src="<?php echo e($artikelTerkait->gambar_url); ?>" alt="<?php echo e($artikelTerkait->judul); ?>">
                    </div>
                    <div class="content">
                        <span class="kategori-mini"><?php echo e($artikelTerkait->kategori); ?></span>
                        <div class="judul"><?php echo e($artikelTerkait->judul); ?></div>
                    </div>
                </a>
...
</html><?php /**PATH E:\Kerjaan\kos_xyz-main\kos_xyz-main\resources\views\public\detail-artikel.blade.php ENDPATH**/ ?>