...
<a href="<?php echo e(route('booking.create', ['kamar_id' => $kamar->id])); ?>" class="btn-booking">
                             <i class="fas fa-calendar-check"></i> Booking Sekarang
                         </a>
                    <?php else: ?>
<a href="<?php echo e(route('booking.create')); ?>" class="btn-booking" style="background:#f59e0b; box-shadow:0 4px 16px rgba(245,158,11,0.3);">
...
</html><?php /**PATH E:\Kerjaan\kos_xyz-main\kos_xyz-main\resources\views\public\detail.blade.php ENDPATH**/ ?>