...
<div style="padding: 0 0 10px 0;">
            ...
            <div class="notif-list">
                ...
                <div class="notif-item">
                    ...
                    <div class="notif-content">
                        ...
                        <div class="time"><i class="far fa-clock"></i> <?php echo e($notif['time'] ?? 'Baru saja'); ?></div>
                    </div>
                </div>
            ...
            <div class="notif-list">
                ...
                <div class="notif-item">
                    ...
                    <div class="notif-content">
                        ...
                        <div class="time"><i class="far fa-clock"></i> <?php echo e($aktivitasItem['time'] ?? 'Baru saja'); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="mini-calendar">
        <div class="mini-header">
            ...
            <a href="<?php echo e(route('admin.tagihan.index')); ?>">Lihat Semua <i class="fas fa-arrow-right"></i></a>
        </div>
        ...
        <div class="mini-stats">
            <div class="stat-box">
                <div class="number blue"><?php echo e($totalMini); ?></div>
                <div class="label">📋 Total</div>
            </div>
            <div class="stat-box">
                <div class="number green"><?php echo e($paidMini); ?></div>
                <div class="label">✅ Lunas</div>
            </div>
            <div class="stat-box">
                <div class="number yellow"><?php echo e($pendingMini); ?></div>
                <div class="label">⏳ Pending</div>
            </div>
            <div class="stat-box">
                <div class="number red"><?php echo e($unpaidMini); ?></div>
        ...
        <div class="mini-grid">
            <?php $__currentLoopData = ['Min','Sen','Sel','Rab','Kam','Jum','Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="day-label"><?php echo e($day); ?></div>
            ...
            <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                ...
                ?>
                <div class="day-cell <?php echo e($isToday ? 'today' : ''); ?>">
                    <?php echo e($day); ?>

                    <?php if($hasEvents): ?>
                        <div class="event-dot <?php echo e($statusClass); ?>"></div>
                    <?php endif; ?>
                </div>
            <?php endfor; ?>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kerjaan\kos_xyz-main\kos_xyz-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>